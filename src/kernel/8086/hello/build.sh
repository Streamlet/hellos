...
wlink format raw bin name kernel.bin option nodefaultlibs option eliminate option offset=0x9C000 option start=_start file bootstrap.obj,kernel.obj >/dev/null
