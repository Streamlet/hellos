...
wlink format raw bin name kernel.bin option nodefaultlibs option eliminate option offset=0x80000 option start=_start file bootstrap.obj,hal.obj,kernel.obj
